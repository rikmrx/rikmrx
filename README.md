...
I am a third-year Bachelor of Cyber Security student at Deakin University, minoring in Security Management. Backed by a Certificate III in Information Technology, I have a strong foundation in hardware, networking, and help desk support, coupled with a dedication to solving complex security challenges.

## Objective

My journey in computer science has led me to develop a passion for cybersecurity, and I am now eager to transition into a Security Operations Center (SOC) as a Tier 1 Analyst. Ultimately, I aim to combine technical threat-hunting skills with my deep interest in Governance, Risk, and Compliance (GRC), with long-term aspirations of taking my career international and relocating to the Netherlands.
...
- **SOC Automation Project:** [Brief 1-sentence description of the SOAR pipeline]
...
- **Academic Network Forensics:** Analyzed packet captures to investigate network attacks, including identifying exactly 29,719 unique IVs from tool outputs during an investigation.
